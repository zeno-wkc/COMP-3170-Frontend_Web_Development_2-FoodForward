      ...
      <div className='food-card__container'>
        ...
        {photo ? (
          <>
            ...
            />
            <br />
            <button onClick={handleRetakePhoto} style={{ padding: '10px 20px', cursor: 'pointer' }}>
              Retake Photo
            </button>
          </>
        ) : (
        ...
        <div className='food-card-content'>
          <div className='food-name'>
            {isEditing ? ( <input type="text" name="foodname" value={foodName} placeholder='Enter your food itemName'  autofocus onChange={(e) => setFoodName(e.target.value)} /> ) : ( <span>{foodName || "Unnamed Food"}</span> )}
